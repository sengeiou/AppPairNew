...
import com.lys.kit.activity.ActivityRecord;
...
public class LysRecordPlugin implements IPluginModule, IPluginRequestPermissionResultCallback
{
	private static final int REQUEST_CODE_RECORD = 123;
	...
	{
		return ContextCompat.getDrawable(context, R.drawable.plugin_record_selector);
	}
	...
	private void start(Fragment fragment, RongExtension extension)
	{
		...
		Intent intent = new Intent(fragment.getActivity(), ActivityRecord.class);
		extension.startActivityForPluginResult(intent, REQUEST_CODE_RECORD, this);
	}
