...
public class AdapterNoteSmall extends RecyclerView.Adapter<AdapterNoteSmall.Holder>
{
	private DialogNotePageGrid owner;
	public SNoteBook book;
	public List<SNotePage> pages;

	public boolean editMode = false;
	public Map<String, SNotePage> selectMap = new HashMap<>();

	public AdapterNoteSmall(DialogNotePageGrid owner, SNoteBook book, List<SNotePage> pages)
	{
		this.owner = owner;
		this.book = book;
		this.pages = pages;
	...
	{
		return new Holder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_note_small, parent, false));
	}
...
//		LOG.v("holder.small.getWidth():" + holder.small.getWidth()); // 根据这个值决定缩略图的生成宽度
		...
		layoutParams.width = FragmentNotePage.SMALL_WIDTH;
