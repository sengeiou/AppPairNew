...
public class AdapterShopClass extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
	private ActivityShopClass owner = null;

	private List<List<SMatter>> matterGroups = new ArrayList<>();

	public AdapterShopClass(ActivityShopClass owner)
	{
		this.owner = owner;
	}
	...
	public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
	{
		switch (viewType)
		{
		case AdapterShopHome.Type_MatterGroupClass:
			return new AdapterShopHome.HolderMatterGroupClass(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_matter_group_class, parent, false));
		}
		return null;
	}
	...
	public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, final int position)
	{
		...
		if (getItemViewType(position) == AdapterShopHome.Type_MatterGroupClass)
		{
			AdapterShopHome.HolderMatterGroupClass holderGroup = (AdapterShopHome.HolderMatterGroupClass) viewHolder;
	...
	{
		return AdapterShopHome.Type_MatterGroupClass;
	}
