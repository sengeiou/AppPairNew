...
import com.lys.App;
import com.lys.adapter.AdapterShopClass;
...
public class ActivityShopClass extends AppActivity implements View.OnClickListener
{
...
//	private String userId;
	...
	private AdapterShopClass adapter;
...
//		userId = getIntent().getStringExtra("userId");
		...
		adapter = new AdapterShopClass(this);
	...
	public void request()
	{
		...
		request.type = SMatterListType.Class;
