...
import com.lys.adapter.AdapterNoteSmall;
...
public class DialogNotePageGrid extends Dialog implements View.OnClickListener
{
	...
	private AdapterNoteSmall adapter;

	public DialogNotePageGrid(@NonNull Context context, SNoteBook book, List<SNotePage> pages)
	{
		super(context, R.style.FullDialog);
//		setCancelable(false);
		setContentView(R.layout.dialog_note_page_grid);
		initHolder();
		...
		adapter = new AdapterNoteSmall(this, book, pages);
	...
	public void onClick(View view)
	{
		...
		case R.id.copy:
			...
			else
			{
				...
				clipboard.data1 = AppConfig.getNoteDir(getContext(), adapter.book);
...
//		{
//			AdapterNoteSmall.Holder holder = (AdapterNoteSmall.Holder) recyclerView.findViewHolderForAdapterPosition(i);
//			if (holder != null)
